...
//             if (user.email && user.firstName) { // Ensure user has an email and firstName
//                 await sendEmail(
//                     user.email,
...
//                 );
//             } else {
//                 console.log('Missing email or firstName for a user, skipping...');
//             }
//         }
...
// // Run the function
// fetchUsersAndSendEmails().catch(console.error);


// // Add at the end of your sendEmails.js file:
